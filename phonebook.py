        ...
        for j in range(cols):
            ...
            if j==2:
                ...
                if temp[j]=='' or temp[j]==' ':
                    temp[j]=None
            if j==3:
                temp.append(str(input("Enter date if birth(dd/mm/yy): ")))
                if temp[j]=='' or temp[j]== ' ':
                    temp[j]=None
            if j==4:
...
def search_existing(pb):
    ...
    if choice ==1:
        ...
        query = int(input("Please enter the name of the contact you wish to search: "))
        for i in range(len(pb)):
            if query == pb[i][0]:
                check = i
                temp.append(pb[i])
       ...
       query = str(input("Please enter the DOB (int dd/mm/yy format ONLY)\of the contact you wish to search:"))
       for i in range(len(pb)):
           if query == pb[i][3]:
               check = i
               temp.append(pb[i])
...
def thanks():
 ...
 sys.exit("Goodbye, have a nice day ahead!")
print(".............................................................................................................")
print("Hello dear user, welcome to our sarthone directory system")
